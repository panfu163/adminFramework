const product = [
  ...
  },
  {
    ...
    component: () => import("@/views/message/signature.vue")
  },
  {
  ...
  },
  {
    ...
    component: () => import("@/views/message/applyFor.vue")
  },
  {
    ...
    component: () => import("@/views/message/addApplyFor.vue")
  },
  {
    path: "/message/audit",
    name: "messageaudit",
    ...
    component: () => import("@/views/message/audit.vue")
  },
  {
    ...
    component: () => import("@/views/message/company.vue")
  },
  {
    path: "/message/addAudit",
    name: "messageaddAudit",
    meta: {
      title: "审核内容",
      navigation: "message" //处理导航显示-子路由需和父路由一至
    },
    component: () => import("@/views/message/addAudit.vue")
  }
];
